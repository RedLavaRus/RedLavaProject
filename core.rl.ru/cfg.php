...
class CFG
{
    ...
    public static $debag   =true;//дебаг режим
    public static $auth_type   = "default";//Тип Авторизации
    public static $minimum_login  = 4;//Минимальная длина логина
    public static $maximum_login  = 15;//Максимальная длина логина
    public static $minimum_password   = 8;//Минимальная длина пароля
    public static $maximum_password   = 16;//Максимальная длина пароля
    public static $salt   = "usy@#2jkw";//Статичная соль
    public static $loger   = true;//включить логер(нагрузка на бд!)
    ...
    public static $telegram_token       = "1390767167:AAEQYQDdCKkt3BVx_CEUNo7vSZr7YPfT_Dg";//токен телеги
    public static $telegram_chat        = "477850396";//ид чата телеги
