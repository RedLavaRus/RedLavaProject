...
<div class="windows_action_1200">
    <h2>Заголовок</h2>
    <div class="windiws_passiv_zone">ggrergrgrgfgdfgvbtbtbtg</div>
...
<div class="but">Сменить</div></div>
<div class="title color_orange">Добавить пользователя
<div class="but">Добавить</div></div>
<div class="title color_gold">Показать статистику
<div class="but">Показать</div></div>

<div class="title color_limegreen">Сменить пароль 
<div class="but">Сменить</div></div>
<div class="title color_mediumseagreen">Сменить ФИО
<div class="but">Сменить</div></div>
<div class="title color_darkturquoise">Добавить пользователя
<div class="but">Добавить</div></div>
<div class="title color_deepskyblue">Показать статистику
<div class="but">Показать</div></div>


<div class="title color_violet">Добавить пользователя
<div class="but">Добавить</div></div>
